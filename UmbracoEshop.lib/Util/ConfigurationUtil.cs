...
namespace UmbracoEshop.lib.Util
{
    public class ConfigurationUtil
    {
        ...
        public const string EshopZoznamVyrobcovFormId = "eshop.EshopZoznamVyrobcovFormId";
        public const string EshopZoznamVyrobkovFormId = "eshop.EshopZoznamVyrobkovFormId";
